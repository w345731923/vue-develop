      ...
      <el-tabs model-value="first" type="card">
        <el-tab-pane label="常规" name="first">
          ...
          <el-form-item label="范本" prop="templateName">
            <el-select v-model="form.templateName" placeholder=" " disabled>
              <el-option
          ...
          <el-form-item label="编码" prop="encoding">
            <el-select v-model="form.encoding" disabled>
              <el-option label="EUC_CN" value="EUC_CN" />
              <el-option label="UTF8" value="UTF8" />
            </el-select>
          </el-form-item>
          <el-form-item label="排序规则排序" prop="collation">
            <el-input v-model="form.collation" disabled/>
          </el-form-item>
          <el-form-item label="字符分类" prop="characterType">
            <el-input v-model="form.characterType" disabled/>
          </el-form-item>
